...
int			img_add_aberration_terms(Bimage* psum, Bimage* psec, Bimage* p, CTFparam& cp, bool ew_flag=0);
Bimage*		img_calculate_phase_differences(Bimage* psum, int check_contrast=0);
