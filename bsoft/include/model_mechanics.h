...
double		model_soft_sphere_energy(Bmodel* model, double Kdistance, double dist_ref, bool wrap, Vector3<double> box);
double		model_lennard_jones_energy(Bmodel* model, double Kdistance, double distance, bool wrap, Vector3<double> box);
double		model_morse_energy(Bmodel* model, double Kdistance, double distance, bool wrap, Vector3<double> box);
